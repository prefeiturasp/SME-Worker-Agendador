pipeline {
    environment {
      ...
      namespace = "${env.branchname == 'development' ? 'sme-agendador-dev' : env.branchname == 'release' ? 'sme-agendador' : env.branchname == 'release-r2' ? 'sme-agendador-hom2' : 'sme-agendador' }" 
    }
